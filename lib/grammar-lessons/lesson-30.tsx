              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className={`flex-1 bg-card border ${feedback["p4q1"] === "correct"
                        ? "border-emerald-500"
                        : "border-border"
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className={`flex-1 bg-card border ${feedback["p4q2"] === "correct"
                        ? "border-emerald-500"
                        : "border-border"
                      } rounded-lg px-3 py-1 text-sm outline-none`}
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className={`flex-1 bg-card border ${feedback["p5q1"] === "correct"
                        ? "border-emerald-500"
                        : "border-border"
                      } rounded-lg px-3 py-1 text-sm outline-none`}
                    placeholder="parece / parecen"
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className={`flex-1 bg-card border ${feedback["p5q2"] === "correct"
                        ? "border-emerald-500"
                        : "border-border"
                      } rounded-lg px-3 py-1 text-sm outline-none`}
                    placeholder="parece / parecen"
